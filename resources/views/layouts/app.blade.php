        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     ...
                     <!-- auth checks if there is an authenticated/logged in user -->
                        @if(!request()->is('admin/*'))
                            <!-- This search bar will not show up inside the admin page -->
                        ...
                        @else
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="account-dropdown">
                                        ...
                                        <!-- Display Like -->
                                        <a href="{{ route('like.displaylikeimages', Auth::user()->id) }}" class="dropdown-item"> 
                                            <i class="fa-solid fa-heart text-danger small"></i> Like
                                        </a>
