    ...
    <div class="col-8">
        <form action="{{ route('profile.update') }}" method="post" class="bg-white shadow rounded p-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea name="introduction" name="introduction" id="introduction" rows="5" placeholder="Describe yourself" class="form-control" >{{ old('introduction', $user->introduction) }}</textarea>
            </div>
