<div class="row">
    <div class="col-4">
        ...
        @else
        <i class="fa-solid fa-circle-user text-secondary d-blocktext-center icon-lg"></i>
        @endif
    </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-auto p-2">
                @if(Auth::user()->id === $user->id)
                    <a href="{{ route('profile.edit') }}" class="btn btn-outline-warning btn-sm fw-bold">Edit Profile</a>
                @else
